...
//  Traducciones, menú slide, CV por idioma
// ============================================================
...
(function() {
    ...
    // --------------------------------------------
    // 2. FUNCIÓN DE TRADUCCIÓN + ACTUALIZAR CV
    // --------------------------------------------
    window.setLang = function(lang) {
        ...
        // --------------------------------------------
        // 3. ACTUALIZAR ENLACE DEL CV SEGÚN IDIOMA
        // --------------------------------------------
        var cvLink = document.getElementById('cv-link');
        if (cvLink) {
            cvLink.href = lang === 'es' ? 'CV.pdf' : 'CV.E.pdf';
            cvLink.download = lang === 'es' ? 'CV_es.pdf' : 'CV_en.pdf';
        }
    };

    // --------------------------------------------
    // 4. CARGA INICIAL DEL IDIOMA
    // --------------------------------------------
    var savedLang = localStorage.getItem('lang') || 'es';
    window.setLang(savedLang);

    // --------------------------------------------
    // 5. MENÚ MÓVIL (SLIDE LATERAL)
    // --------------------------------------------
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.addEventListener('scroll', function() {
            if (window.scrollY > 80) {
                header.style.background = 'rgb(47,33,10)';
    ...
    // --------------------------------------------
    // 8. ASIGNAR EVENTOS A BOTONES DE IDIOMA
    // --------------------------------------------
    document.addEventListener('DOMContentLoaded', function() {
        var btnEs = document.getElementById('btn-es');
        var btnEn = document.getElementById('btn-en');
        if (btnEs) btnEs.addEventListener('click', function() { window.setLang('es'); });
